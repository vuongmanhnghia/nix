...
Singleton {
    ...
    Process {
        id: sinkProcess
        command: ["bash", "-c", "$NIX_CONFIG/modules/home-manager/desktop/hyprland/scripts/get-hardware-volume.sh --sink"]
        running: false
    ...
    Process {
        id: sourceProcess
        command: ["bash", "-c", "$NIX_CONFIG/modules/home-manager/desktop/hyprland/scripts/get-hardware-volume.sh --source"]
        running: false
