...

{
  wayland.windowManager.hyprland = {
    settings = {
      ...
      bindel = [
        ", XF86AudioRaiseVolume, exec, ${hostVars.nix_config}/modules/home-manager/desktop/hyprland/scripts/volume.sh --inc"
        ", XF86AudioLowerVolume, exec, ${hostVars.nix_config}/modules/home-manager/desktop/hyprland/scripts/volume.sh --dec"
        ", XF86AudioMute, exec, ${hostVars.nix_config}/modules/home-manager/desktop/hyprland/scripts/volume.sh --toggle"
        ", XF86AudioMicMute, exec, wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"
        ", XF86MonBrightnessUp, exec, ${hostVars.nix_config}/modules/home-manager/desktop/hyprland/scripts/brightness.sh --inc"
        ", XF86MonBrightnessDown, exec, ${hostVars.nix_config}/modules/home-manager/desktop/hyprland/scripts/brightness.sh --dec"
      ];
    };
  };
}
