...

{
  wayland.windowManager.hyprland = {
    settings = {
      ...
      bindl = [
        "$mainMod SHIFT, M, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --toggle" # Toggle mute speakers
        "$mainMod, M, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --toggle-mic" # Toggle mute mic
        ",XF86AudioMute, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --toggle" # [hidden]
        "Alt ,XF86AudioMute, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --toggle-mic" # [hidden]
        ",XF86AudioMicMute, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --toggle-mic" # [hidden]
      ...
      bind = [
        ...
        # "ALT, SPACE, exec, ${vars.nix_config}/scripts/fuzzel/fuzzel.sh" # [hidden] Launcher (fallback)
        ...
        "$mainMod SHIFT, up, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --mic-inc"
        "$mainMod SHIFT, down, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --mic-dec"
        
        "$mainMod, up, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --inc"
        "$mainMod, down, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --dec"
      ...
      bindel = [
        ", XF86AudioRaiseVolume, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --inc"
        ", XF86AudioLowerVolume, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --dec"
        ", XF86AudioMute, exec, ${vars.nix_config}/home/shared/hypr/scripts/volume.sh --toggle"
        ", XF86AudioMicMute, exec, wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"
        ", XF86MonBrightnessUp, exec, ${vars.nix_config}/home/shared/hypr/scripts/brightness.sh --inc"
        ", XF86MonBrightnessDown, exec, ${vars.nix_config}/home/shared/hypr/scripts/brightness.sh --dec"
      ];
    };
  };
}
